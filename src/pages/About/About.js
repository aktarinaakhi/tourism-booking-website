...
const About = () => {
    ...
    return (
        <div id="about" className="about-container d-md-flex container my-5 d-sm-block">
            <div className="w-50">
                <p className="ms-4">About Tour Booking</p>
                <ul style={{ listStyle: 'none', color: '#0071c2' }}>
                    <li>Legal</li>
                    <li>Press center</li>
            ...
            <div className="w-50 ms-4">
                <h2 className="my-3">About Tour Booking™</h2>
